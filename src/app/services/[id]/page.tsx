  ...
  return (
    <div className="min-h-screen flex flex-col bg-tissue text-black selection:bg-peach selection:text-black">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-base font-serif text-black/70 mb-8 flex-wrap">
          <Link
            href="/"
          ...
          <span aria-hidden="true">/</span>
          <span className="text-black font-serif truncate max-w-xs" aria-current="page">
            {service.title}
          </span>
        </nav>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="rounded-[32px] border-none bg-peach p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
              ...
              <a
                ...
                className="shrink-0 rounded-full bg-black text-tissue px-6 py-3 font-serif text-lg hover:bg-black/90 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
              >
                Chat WhatsApp
              </a>
            </div>
